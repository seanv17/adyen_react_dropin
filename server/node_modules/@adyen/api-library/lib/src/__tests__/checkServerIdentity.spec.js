...
describe("Certificate Server Identiy", function () {
    test.each([
        ...
        expect((0, checkServerIdentity_1.default)("any", mockedCertificate)).toBeUndefined();
    });
    test.each([
        "INVALID.adyen.com",
        ...
        const mockedCertificate = createMockedCertificate(cn);
        expect((0, checkServerIdentity_1.default)("any", mockedCertificate) instanceof Error).toBeTruthy();
    });
    test.each([
